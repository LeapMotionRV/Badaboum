...
namespace render
{
	...
	void Skybox::createTexture() {
		//Up
		juce::File fileSkyboxUp = juce::File::getCurrentWorkingDirectory().getChildFile("../../data/skyboxUp.png");
		...
		//Left
		juce::File fileSkyboxLeft = juce::File::getCurrentWorkingDirectory().getChildFile("../../data/skyboxLeft.png");
		...
		//Right
		juce::File fileSkyboxRight = juce::File::getCurrentWorkingDirectory().getChildFile("../../data/skyboxRight.png");
		...
		//Forward
		juce::File fileSkyboxForward = juce::File::getCurrentWorkingDirectory().getChildFile("../../data/skyboxForward.png");
		...
		//Back
		juce::File fileSkyboxBack = juce::File::getCurrentWorkingDirectory().getChildFile("../../data/skyboxBack.png");
