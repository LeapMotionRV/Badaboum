...
namespace physical 
{
	Model::Model(unsigned int countParticles)
	{
		...
		//m_pParticleManager->addParticle(glm::vec3(0.5f, 0.f, 0.5f), glm::vec3(0.f, 0.f, 0.f), 0.25f, glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.f, 0.f, 1.f));
		...
		m_pGravity = new ConstantForce(glm::vec3(0.f, -0.1f, 0.f));
