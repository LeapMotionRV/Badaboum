...
namespace physical
{
	...
	Cube::Cube(physical::ParticleManager* pParticuleManager)
	{
		...
		//face 2
		m_graph->push_back(std::make_pair(part6,part5));
		...
		m_graph->push_back(std::make_pair(part8,part4));
		m_graph->push_back(std::make_pair(part6,part2));
		m_graph->push_back(std::make_pair(part7,part3));*/
		//diagonales
		/*m_graph->push_back(std::make_pair(part5,part3));
		m_graph->push_back(std::make_pair(part2,part8));
		m_graph->push_back(std::make_pair(part1,part7));
		m_graph->push_back(std::make_pair(part6,part4));
		*/
