...
namespace physical
{
	...
	Cube::Cube(physical::ParticleManager* pParticuleManager)
	{
		...
		m_cubeGraph->push_back(std::make_pair(part2,part4));
		m_cubeGraph->push_back(std::make_pair(part5,part7));
		m_cubeGraph->push_back(std::make_pair(part6,part8));

		m_cubeGraph->push_back(std::make_pair(part5,part4));
		m_cubeGraph->push_back(std::make_pair(part1,part8));
		m_cubeGraph->push_back(std::make_pair(part6,part3));
		m_cubeGraph->push_back(std::make_pair(part2,part7));

		m_cubeGraph->push_back(std::make_pair(part2,part5));
		m_cubeGraph->push_back(std::make_pair(part1,part6));
		m_cubeGraph->push_back(std::make_pair(part3,part8));
		m_cubeGraph->push_back(std::make_pair(part4,part7));

		////////////////////////////////////////
		
		/*	m_cubeGraph->push_back(std::make_pair(part2,part1));
		m_cubeGraph->push_back(std::make_pair(part3,part2));
		m_cubeGraph->push_back(std::make_pair(part4,part3));
		m_cubeGraph->push_back(std::make_pair(part1,part4));*/
		//face 2
		/*m_cubeGraph->push_back(std::make_pair(part5,part6));
		m_cubeGraph->push_back(std::make_pair(part6,part7));
		m_cubeGraph->push_back(std::make_pair(part7,part8));
		...
		//diagonales faces
		//m_cubeGraph->push_back(std::make_pair(part3,part1));
