...
void OpenGLCanvas::renderOpenGL()
{
	...
	*/
	...
	// draw a box
	{
		...
		LeapUtilGL::drawBox(LeapUtilGL::eStyle::kStyle_Solid, 0.2f);
	}
...
void OpenGLCanvas::paint(Graphics&)
{
}
...
void OpenGLCanvas::onInit(const Leap::Controller&) 
{
}

void OpenGLCanvas::onConnect(const Leap::Controller&) 
{
}

void OpenGLCanvas::onDisconnect(const Leap::Controller&) 
{
}

void OpenGLCanvas::onFrame(const Leap::Controller& controller)
{
    if ( !m_bPaused )
    {
